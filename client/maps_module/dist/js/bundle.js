...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('md-list',_vm._l((_vm.elements),function(element){return _c('md-list-item',{on:{"click":function($event){_vm.action(element.id)}}},[_c('span',[_vm._v(_vm._s(element.title))])])}))}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-8d9409a6"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8d9409a6", __vue__options__)
  } else {
    hotAPI.reload("data-v-8d9409a6", __vue__options__)
  }
})()}

},{"vue":75,"vue-hot-reload-api":73}],2:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".brazil-map[data-v-3531f81d]{\n\twidth: 960px;\n\theight: 640px !important;\n}")
;(function(){
"use strict";
...
(function () {
	...
	module.exports = {
		...
		"methods": {
			getStatesIdName: function getStatesIdName() {
				var stateIdNames = [];
			...
			selectState: function selectState(stateId) {
				this.stateSelected = stateId;
				this.states.forEach(function (state) {
					if (state.id == stateId) state.path.classList.add("selected");else state.path.classList.remove("selected");
				});
			}
		},
		created: function created() {
		...
		mounted: function mounted() {
			var wc = this;
			var svg = document.getElementById("brazil");

			svg.addEventListener("load", function () {
				var svgDoc = svg.contentDocument;
				var paths = svgDoc.getElementsByClassName("land");
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('object',{staticClass:"brazil-map",attrs:{"id":"brazil","data":_vm.src,"type":"image/svg+xml"}})}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-3531f81d"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3531f81d", __vue__options__)
  } else {
    hotAPI.reload("data-v-3531f81d", __vue__options__)
  }
})()}

},{"vue":75,"vue-hot-reload-api":73,"vueify/lib/insert-css":77}],3:[function(require,module,exports){
"use strict";
...
(function () {
	...
	module.exports = {
		...
		"post": function post(url, requestParams) {
			return new _promise2.default(function (resolve, reject) {
...
(function () {
	...
	var vueTheme = require("./vue-theme");
	var proxxiMap = require("../js/components/proxxi-map.vue");
	var proxxiList = require("../js/components/proxxi-list.vue");
	...
	new Vue({
		...
		methods: {
			...
			updateMap: function updateMap(id) {
...
},{"../js/components/proxxi-list.vue":1,"../js/components/proxxi-map.vue":2,"../js/http":3,"./vue-theme":5,"babel-runtime/core-js/promise":7,"vue":75,"vue-material":74}],5:[function(require,module,exports){
"use strict";
...
},{"core-js/library/fn/json/stringify":8}],7:[function(require,module,exports){
...
},{"vue":76}],75:[function(require,module,exports){
(function (global){
/*!
 * Vue.js v2.4.1
